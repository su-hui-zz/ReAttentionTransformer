...
__C.MODEL.SELECT_NUM = 50
__C.MODEL.SCORE_NUM = 25
__C.MODEL.THRESH = 0.02
__C.MODEL.POSWEIGHTS  = ""
...
__C.TEST.METRICS = 'gt_top'  # 'gt-top': gt-known and top1/5 acc metrics; 'maxboxaccv2': MaxBoxAccv2 metrics
...
def cfg_from_file(filename):
    ...
    with open(filename, 'r') as fopen:
        yaml_config = AttrDict(yaml.safe_load(fopen))
